...
Então decidiram fazer isso de uma forma simples, com combates no modo 1x1 e vencendo quem tem o Digitron com maior valor de golpe, que é definido da seguinte forma:
...
Nas duas linhas seguintes terão três inteiros Ai, Di e Li (1 ≤ Ai, Di ≤ 100, 1 ≤ Li ≤ 50), representado o valor de ataque do Digitron, o valor de defesa e o level do treinador.
...
public class Desafio2 {public static void main(String[] args) throws IOException {
    Scanner leitor = new Scanner(System.in);
    System.out.println("Número de instâncias: ");
    int T = leitor.nextInt();
    int B, A1, D1, L1, A2, D2, L2, V1, V2;
    for (int i = 0; i < T; i++) {
        System.out.print("Bônus aplicado: ");
        B = leitor.nextInt();
        System.out.print("Valor do ataque: ");
        A1 = leitor.nextInt();
        System.out.print("Valor da defesa: ");
        D1 = leitor.nextInt();
        System.out.print("Level do treinador: ");
        L1 = leitor.nextInt();
        System.out.print("Valor do ataque: ");
        A2 = leitor.nextInt();
        System.out.print("Valor da defesa: ");
        ...
        if (V1 > V2) System.out.println("Bruno é o vencedor");
        else if (V2 > V1) System.out.println("Guarte é o vencedor");
